...
public class Manutencao {
  ...
  @SequenceGenerator(name = "sq_tp_manutencao", sequenceName = "sq_tp_manutencao", allocationSize = 1)
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sq_tp_manutencao")
  private int id;
